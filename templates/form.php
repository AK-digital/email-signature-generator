<div id="esg-main">
	...
	<form action="" method="POST" name="signatureForm" enctype="multipart/form-data" id="signature-form" class="esg_flex-two-col">
		...
		<input type="text" id="title" name="title" placeholder="Job title" class="wpcf7-form-control wpcf7-text" required>
		<input type="email" id="email" name="email" placeholder="Email" class="wpcf7-form-control wpcf7-text">
		<input type="text" id="mobile" name="mobile" placeholder="Phone" class="wpcf7-form-control wpcf7-text""
		required>
