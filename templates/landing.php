<header id="esg-landing_header">
    ...
    <?php if (isset($_POST['submit'])): ?>
        <form action="<?php unset($_POST['submit']) ?>">
            <input type="submit" class="qbutton default" name="submit" value="Reset"/>
        </form>
    <?php endif; ?>
</header>

<section>
    <div class="wrapper full-width container">
        <ul class="nav egs_nav-tabs" style="float:left">
            <li class="fadeIn active"><a href="#sign-preview">Preview</a></li>
            <li class="fadeIn"><a href="#sign-html">HTML</a></li>
        </ul>

        <ul class="nav egs_nav-tabs" style="float:right">
            <label>Setup guides</label>
        ...
        <div class="egs_tab-content">
            <div id="sign-preview" class="egs_tab-pane fadeIn active">
                <?php echo $signature; ?>
                <div class="esg_action-bar">
                    <button class="esg_button esg_button-copy"
                            onclick="copyToClip(document.getElementById('sign-preview').innerHTML)"><img src="<?= $this->plugin_url;?>assets/img/copy-icon.png"/>Copy signature
                    </button>
                    <button class="esg_button downloadLink">
                        <img src="<?= $this->plugin_url;?>assets/img/download-icon.png"/>Download signature</button>
                </div>
            </div>

            <div id="sign-html" class="egs_tab-pane fadeIn">
...
<?php echo $signature; ?>
                ...
                <div class="esg_action-bar">
                    ...
                    <button class="esg_button downloadLink"><img src="<?= $this->plugin_url;?>assets/img/download-icon.png"/>Download signature</button>
                </div>
            </div>
            ...
            <div id="tab-6" class="egs_tab-pane fadeIn">
                ...
                <ol>
                    <li>
                        <button class="esg_button downloadLink">Download your signature</button>
                    </li>
